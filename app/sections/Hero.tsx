    ...
    <section className="pt-6 pb-20 md:pt-4 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,_#183EC2,_#EAEEFE_66%)]" >
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:w-[500px] lg:w-[800px]">
            <div className="text-black text-sm px-3 py-1 border-2 border-gray-300 w-40 inline-flex rounded-lg">Version 2.0 is here</div>
            <h2 className="text-5xl font-bold tracking-tighter mt-6 md:text-5xl lg:text-8xl" style={TextGradient}>Pathway to productivity</h2>
          ...
          <div className="mt-12 md:mt-0 relative ">
            ...
            <Image
              ...
              height={170}
              quality={100}
              className="hidden md:block absolute md:right-[260px] md:top-[-40px] lg:right-[520px] lg:top-[-10px] "
            />
          </div>
        </div>
