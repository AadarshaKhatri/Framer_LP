      ...
      <div className="flex flex-col justify-between items-center">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center mt-5 space-y-5 lg:space-x-10">
            <div className="h-[420px] w-[350px] border-2 border-gray-100 shadow-md rounded-md bg-white">
                <div className="flex flex-col px-5 justify-between items-center">
                <Image 
                  ...
                  <h2 className="text-center py-1 text-black text-lg font-bold pb-1">Integration Ecosystem</h2>
                  <p className="text-center text-gray-900 text-sm pb-3">Enhance you productivity by connecting with your favorite tools, keeping it all your essentials in one place</p>
              ...
              <Image 
                ...
                <h2 className="text-center py-1 text-black text-lg font-bold pb-1">Goal Setting and tracking</h2>
                <p className="text-center text-gray-900 text-sm pb-3">Define and track your goals, breaking down objectives into achievable tasks to keep your targets in sight.</p>
